...
const CATEGORY_MODULES = {
    resume: {
        ...
        module1: {
            ...
            content: (id, name) => {
                const advice = {
                    'classic-resume': '✅ 适合国企、事业单位、传统行业、管理培训生\n✅ 建议配合正式正装照片使用\n✅ 可以根据目标岗位调整简历侧重点',
                    'modern-resume': '✅ 适合互联网、科技、创意设计、媒体广告\n✅ 建议附上作品集链接(Dribbble/Behance)\n✅ 可以使用互联网风格的设计元素',
                    'developer-resume': '✅ 适合IT/软件/互联网公司技术岗位\n✅ 技术栈要针对目标公司做定制化调整\n✅ 建议附上GitHub和技术博客链接',
                    'designer-resume': '✅ 适合设计公司、品牌方、互联网产品设计\n✅ 作品集是核心，必须提供访问链接\n✅ 可以展示设计过程和思路',
                    'pm-resume': '✅ 适合互联网产品经理、创业公司负责人\n✅ 突出产品成果和用户规模数据\n✅ 建议附上产品分析报告或原型链接',
                    'teacher-resume': '✅ 适合学校、培训机构、教育管理\n✅ 教师资格证编号必须标注\n✅ 突出班主任经历和教学成果',
                    'simple-resume': '✅ 适合应届生、实习、跨行业转型\n✅ 内容精简，重点突出核心优势\n✅ 适合职位要求简洁的岗位',
                    'two-column-resume': '✅ 适合资深职场人、管理层、外企\n✅ 信息密度高，可展示多方面经历\n✅ 适合有丰富背景需要同时展示的人',
                    'single-column-resume': '✅ 适合国企、传统行业、体制内\n✅ 信息清晰易读，正式规范\n✅ 适合需要快速筛选的HR',
                    'fresh-graduate-resume': '✅ 适合校园招聘、应届生申请\n✅ 教育背景和实习经历并重\n✅ 突出学习能力和成长潜力',
                    'intern-resume': '✅ 适合在校学生实习申请\n✅ 明确标注可实习时间和周期\n✅ 突出学习能力和积极性',
                    'english-resume': '✅ 适合外资企业、海外工作岗位\n✅ 全英文格式，符合国际惯例\n✅ 可以不附照片',
                    'nurse-resume': '✅ 适合医院、诊所、医疗护理岗位\n✅ 护士资格证编号是必须项\n✅ 突出临床技能和急救经验',
                    'accountant-resume': '✅ 适合企业财务、会计事务所、金融机构\n✅ CPA、中级会计等证书要突出\n✅ 量化财务工作成果',
                    'sales-resume': '✅ 适合销售、业务拓展、客户管理\n✅ 用销售数字说话是关键\n✅ 展示客户资源和谈判能力'
                };
                return advice[id] || '✅ 适合大多数职位申请\n✅ 根据目标岗位调整简历重点\n✅ 突出与岗位相关的能力和经验';
            }
        },
        module2: {
            title: '🎯 面试官关注重点',
            content: (id, name) => {
                const focuses = {
                    'classic-resume': '🎯 教育背景和学历层次\n🎯 实习经历的具体工作内容\n🎯 校园活动和领导力经历\n🎯 沟通表达能力和举止仪表',
                    'developer-resume': '🎯 技术栈与岗位匹配度\n🎯 项目经验的技术深度\n🎯 问题解决能力和思路\n🎯 编码习惯和代码质量',
                    'teacher-resume': '🎯 教学成果和学生成绩提升数据\n🎯 班主任和管理经验\n🎯 教研能力和学术成果\n🎯 亲和力和表达沟通能力',
                    'pm-resume': '🎯 产品经验和用户规模\n🎯 数据分析能力证明\n🎯 跨部门协调和推动能力\n🎯 产品思维和方法论',
                    'default': '🎯 与岗位相关的能力证明\n🎯 项目经验和成果数据\n🎯 学习能力和成长潜力\n🎯 沟通表达和团队协作'
                };
                return focuses[id] || focuses['default'];
            }
        },
        module3: {
            title: '✨ 简历优化技巧',
            content: (id, name) => {
                const tips = {
                    'classic-resume': '📌 用Action Verb开头：负责、主导、完成、推动\n📌 量化成果：提升了X%、增长了X元、缩短了X天\n📌 使用行业关键词：通过ATS关键词筛选\n📌 定期更新：根据岗位定制简历内容',
                    'developer-resume': '📌 技术栈按熟练程度分层展示\n📌 项目描述用STAR法则：情境-任务-行动-结果\n📌 突出解决的技术难点和方案\n📌 GitHub要有内容，保持活跃度',
                    'teacher-resume': '📌 用数据展示教学成果：提升X分、升学率X%\n📌 突出班主任经历和家长沟通能力\n📌 展示教研成果：论文、课题、教材\n📌 准备教学相关证书和荣誉证明',
                    'default': '📌 简洁专业，重点突出\n📌 量化工作成果用数据说话\n📌 定期更新简历内容\n📌 针对不同岗位做定制化调整'
                };
    ...
    budget: {
        ...
        module1: {
            ...
            content: (id, name) => {
                const formulas = {
                    'monthly-budget': '📈 SUM求和：=SUM(B2:B30) 计算月度总支出\n📈 IF条件：=IF(B2>预算,"超支","正常") 预警超支\n📈 AVERAGE平均：=AVERAGE(B2:B30) 计算月均支出\n📈 VLOOKUP查找：自动匹配预算类别',
                    'annual-budget': '📈 SUMIF条件求和：=SUMIF(A:A,"餐饮",B:B) 按类别汇总\n📈 YEAR/MONTH日期：提取年度月份数据\n📈 INDEX+MATCH查找：跨表匹配数据\n📈 数据透视表：快速汇总年度收支',
                    'household-budget': '📈 自动求和：=SUBTOTAL(109,B2:B30) 排除隐藏行\n📈 条件格式：高亮超支项目\n📈 数据验证：下拉菜单选择分类\n📈 图表可视化：柱状图展示月度趋势',
                    'default': '📈 SUM求和：=SUM(B2:B10) 计算总计\n📈 IF条件：=IF(B2>1000,"超支","正常")\n📈 AVERAGE平均：=AVERAGE(B2:B10)\n📈 VLOOKUP查找：自动匹配数据'
                };
        ...
        module2: {
            ...
            content: (id, name) => {
                const methods = {
                    'monthly-budget': '🔒 50-30-20法则：50%必要支出，30%可选，20%储蓄\n🔒 优先级排序：先保证必需支出，有余力再考虑其他\n🔒 准备应急基金：预留10%作为意外支出\n🔒 每周检查一次预算执行情况',
                    'annual-budget': '🔒 十二分之一法则：每月储蓄额 = 年储蓄目标/12\n🔒 季度复盘：每季度检查进度，年底前完成目标\n🔒 大件分摊：大型支出按月分摊计入预算\n🔒 自动转账：设置工资到账自动转储蓄',
                    'household-budget': '🔒 家庭会议：每月讨论财务目标和执行情况\n🔒 透明公开：夫妻双方财务透明，共同决策\n🔒 教育金专项：孩子教育金单独规划\n🔒 养老规划：提前规划退休储蓄',
                    'default': '🔒 记录每一笔支出，不要遗漏\n🔒 区分必要支出和欲望支出\n🔒 设定储蓄目标，先存后花\n🔒 定期复盘调整预算'
                };
                return methods[id] || methods['default'];
            }
        },
        module3: {
            title: '📈 财务规划建议',
            content: (id, name) => {
                const advice = {
                    'monthly-budget': '📊 紧急备用金：保留3-6个月生活费在货币基金\n📊 债务管理：优先还清高利息债务\n📊 投资规划：储蓄的50%用于低风险投资\n📊 定期检视：每月检查预算执行情况',
                    'annual-budget': '📊 长期目标：设定5-10年的财务目标\n📊 保险规划：配置必要的保险保障\n📊 税务规划：合理利用税收优惠\n📊 传承规划：考虑家庭财富传承',
                    'investment-budget': '📊 资产配置：分散投资降低风险\n📊 定期投资：基金定投养成习惯\n📊 复利效应：越早开始越好\n📊 风险评估：了解自己的风险承受能力',
                    'default': '📊 养成记录收支的习惯\n📊 设定明确的储蓄目标\n📊 学习基础投资知识\n📊 定期检视财务状况'
                };
                return advice[id] || advice['default'];
            }
        }
    },
    ppt: {
        ...
        module1: {
            ...
            content: (id, name) => {
                const structures = {
                    'business-ppt': '📐 金字塔结构：结论先行，以上统下\n📐 背景-问题-方案-价值 逻辑框架\n📐 每页一个核心观点，用数据支撑\n📐 故事线：起承转合，引人入胜',
                    'meeting-ppt': '📐 简单清晰：每页3-5个要点\n📐 时间标注：明确每个议题的时间分配\n📐 行动导向：每项讨论要有结论\n📐 视觉辅助：用图表代替文字',
                    'training-ppt': '📐 知识结构：循序渐进，由浅入深\n📐 案例丰富：每个知识点配合实际案例\n📐 互动设计：留出讨论和练习时间\n📐 记忆点：每页一个核心要点',
                    'default': '📐 结论先行：先说结论再展开\n📐 逻辑清晰：背景-分析-结论\n📐 视觉化：用图表展示数据\n📐 控制节奏：每页停留适当时间'
                };
                return structures[id] || structures['default'];
            }
        },
        module2: {
            title: '🎨 视觉设计原则',
            content: (id, name) => {
                const design = {
                    'business-ppt': '🎨 配色：蓝灰、藏青等专业色系\n🎨 字体：标题黑体，正文微软雅黑\n🎨 图片：高质量配图，与内容相关\n🎨 动画：适度使用，不要喧宾夺主',
                    'marketing-ppt': '🎨 配色：与品牌调性一致\n🎨 字体：统一字号层次\n🎨 数据可视化：图表直观展示数据\n🎨 留白：保持版面呼吸感',
                    'default': '🎨 配色统一：不超过3种主色\n🎨 字体一致：标题和正文用固定字体\n🎨 图文结合：图片辅助说明\n🎨 层次分明：大小标题区分清晰'
                };
                return design[id] || design['default'];
            }
        },
        module3: {
            title: '📊 数据展示技巧',
            content: (id, name) => {
                const dataTips = {
                    'business-ppt': '📊 用柱状图展示对比，饼图展示占比\n📊 折线图展示趋势变化\n📊 关键数据放大突出显示\n📊 数据来源要标注，增加可信度',
                    'marketing-ppt': '📊 前后对比：展示改进前后的效果差异\n📊 漏斗图：展示转化率变化\n📊 热力图：展示用户行为分布\n📊 数字说话：用具体数据证明观点',
                    'default': '📊 图表优先于文字：用图表代替表格\n📊 标注关键数据：让观众一眼看到重点\n📊 数据来源：注明数据出处增加可信度\n📊 避免歧义：图表要有明确标题和标签'
                };
                return dataTips[id] || dataTips['default'];
            }
        }
    },
    'project-plan': {
        ...
        module1: {
            ...
            content: (id, name) => {
                const methods = {
                    'agile-plan': '📌 User Story Map：从用户视角拆解功能\n📌 Sprint规划：2周为一个迭代周期\n📌 任务分解：Epic→Story→Task 层层分解\n📌 Definition of Done：明确完成标准',
                    'waterfall-plan': '📌 WBS分解：工作分解结构，层层细化\n📌 任务分配：RACI矩阵明确责任人\n📌 依赖关系：识别任务间的依赖和约束\n📌 里程碑设置：关键节点设置评审',
                    'startup-plan': '📌 MVP优先：最小可行产品快速验证\n📌 假设验证：关键假设优先测试\n📌 敏捷调整：根据反馈快速迭代\n📌 资源限制：明确核心资源和约束',
                    'default': '📌 从大到小：从项目到阶段到任务\n📌 任务粒度：每个任务1-3天可完成\n📌 依赖识别：明确任务间的先后关系\n📌 资源匹配：确保人员和时间充足'
                };
                return methods[id] || methods['default'];
            }
        },
        module2: {
            ...
            content: (id, name) => {
                const risks = {
                    'agile-plan': '🔍 风险识别：每个Sprint识别top3风险\n🔍 风险量化：评估概率和影响程度\n🔍 应对策略：规避、转移、减轻、接受\n🔍 风险缓冲：预留应急时间和预算',
                    'waterfall-plan': '🔍 风险评审：每个阶段门禁检查风险\n🔍 应急预案：关键路径任务准备B方案\n🔍 监控预警：设置风险指标监控\n🔍 变更控制：严格管理范围蔓延',
                    'default': '🔍 风险识别：列出项目主要风险\n🔍 风险评估：概率高且影响大的优先关注\n🔍 应对计划：为每个重大风险准备应对方案\n🔍 定期回顾：每月检视风险状态'
                };
                return risks[id] || risks['default'];
            }
        },
        module3: {
            title: '📊 甘特图应用',
            content: (id, name) => {
                const gantt = {
                    'agile-plan': '📊 Sprint甘特图：展示每个Sprint的任务安排\n📊 燃尽图：追踪Sprint剩余工作量的变化\n📊 版本线：标注关键版本发布日期\n📊 资源负载：展示团队成员的工作分配',
                    'waterfall-plan': '📊 阶段甘特图：展示项目各阶段的起止时间\n📊 关键路径：标注项目的关键路径\n📊 里程碑：标注关键节点和交付物\n📊 依赖关系：展示任务间的先后约束',
                    'default': '📊 时间轴：清晰展示任务起止时间\n📊 里程碑：标注关键节点和交付物\n📊 进度追踪：用颜色或填充表示完成度\n📊 资源可视化：展示人员分配情况'
                };
                return gantt[id] || gantt['default'];
            }
        }
    },
    okr: {
        ...
        module1: {
            ...
            content: (id, name) => {
                const methods = {
                    'company-okr': '🎯 战略对齐：公司OKR支撑战略目标\n🎯 自上而下：总部先定，各部门承接\n🎯 挑战目标：目标要有挑战性，70%完成度为佳\n🎯 公开透明：全公司可见，促进对齐',
                    'department-okr': '🎯 承接公司：部门OKR支撑公司OKR\n🎯 跨部门协调：关联部门OKR要协调\n🎯 资源配置：OKR需要匹配相应资源\n🎯 定期同步：每月检查进度和偏差',
                    'personal-okr': '🎯 成长导向：个人OKR聚焦能力提升\n🎯 可衡量：KR要有明确的衡量标准\n🎯 与工作结合：OKR要与日常工作任务结合\n🎯 自我驱动：主动设定有挑战的目标',
                    'default': '🎯 目标O：有挑战性、鼓舞人心、方向明确\n🎯 关键结果KR：可量化、可实现、有时限\n🎯 聚焦重点：每个周期聚焦3-5个核心目标\n🎯 公开透明：OKR要对团队可见'
                };
                return methods[id] || methods['default'];
            }
        },
        module2: {
            ...
            content: (id, name) => {
                const review = {
                    'company-okr': '📈 评分标准：0.6-0.7完成预期，0.8-1.0超预期\n📈 季度评分：季度末进行评分和回顾\n📈 复盘内容：完成情况、经验教训、下期改进\n📈 与绩效脱钩：OKR不是绩效考核依据',
                    'department-okr': '📈 中期检查：第6周进行进度检查\n📈 评分讨论：团队一起评分和讨论\n📈 经验沉淀：好的实践固化，差的改进\n📈 跨部门对齐：与关联部门同步OKR进展',
                    'personal-okr': '📈 周检视：每周五回顾本周OKR进展\n📈 月评分：每月进行自我评分\n📈 季度复盘：总结本季度学习成长\n📈 学习曲线：记录能力提升的轨迹',
                    'default': '📈 评分尺度：0-1分，0.6是及格线\n📈 自评+确认：先自评再与上级确认\n📈 复盘改进：分析差距原因，调整下期OKR\n📈 持续迭代：OKR不是一次性工具'
                };
                return review[id] || review['default'];
            }
        },
        module3: {
            title: '🔗 OKR与绩效管理',
            content: (id, name) => {
                const perf = {
                    'company-okr': '🔗 战略落地：OKR是战略落地的工具\n🔗 组织对齐：全公司聚焦同一目标\n🔗 文化塑造：高绩效文化的基础\n🔗 资源配置：OKR指导资源分配决策',
                    'department-okr': '🔗 团队协同：部门OKR要与其他部门对齐\n🔗 资源协调：基于OKR优先级协调资源\n🔗 绩效参考：OKR是绩效面谈的参考\n🔗 持续改进：通过OKR发现团队短板',
                    'personal-okr': '🔗 成长记录：OKR记录个人成长轨迹\n🔗 能力聚焦：每个周期聚焦2-3项核心能力\n🔗 反馈循环：通过OKR获得及时反馈\n🔗 职业发展：OKR与职业发展规划结合',
                    'default': '🔗 目标对齐：个人目标支撑团队目标\n🔗 进展追踪：通过OKR追踪成长进度\n🔗 反馈机制：定期获得上级反馈\n🔗 持续改进：在OKR中学习成长'
                };
                return perf[id] || perf['default'];
            }
        }
    },
    'daily-report': {
        ...
        module1: {
            ...
            content: (id, name) => {
                const methods = {
                    'daily-report-template': '📝 关键任务法：只记录最重要的3件事\n📝 番茄工作法：按25分钟分段记录\n📝 问题导向：重点记录遇到的问题和解决方案\n📝 数据说话：用数字量化工作成果',
                    'weekly-report-template': '📝 周度视角：总结本周完成的关键成果\n📝 下周计划：提前规划下周重点工作\n📝 跨项目追踪：同时追踪多个项目的进展\n📝 数据汇总：用数据展示一周的工作量',
                    'monthly-report-template': '📝 月度视角：总结本月核心成果和KPI\n📝 问题分析：深入分析遇到的问题和根因\n📝 经验沉淀：沉淀可复用的工作方法和经验\n📝 下月规划：设定下月目标和关键任务',
                    'default': '📝 简洁明了：控制在5行以内\n📝 重点突出：只记录关键任务和成果\n📝 时间顺序：按时间或优先级排列\n📝 反思改进：记录问题和改进想法'
                };
                return methods[id] || methods['default'];
            }
        },
        module2: {
            ...
            content: (id, name) => {
                const time = {
                    'daily-report-template': '⏰ 四象限法：按重要紧急程度分配时间\n⏰ 番茄工作法：25分钟专注工作，5分钟休息\n⏰ 批量处理：同类任务集中处理\n⏰ 早起规划：早上10分钟规划全天工作',
                    'weekly-report-template': '⏰ 周一规划：明确本周最重要的5件事\n⏰ 周三检视：中期检查进度，调整计划\n⏰ 周五复盘：总结本周完成情况\n⏰ 预留缓冲：留出20%时间处理意外',
                    'monthly-report-template': '⏰ 月初目标：设定本月核心目标\n⏰ 周度追踪：每周检查月度目标进度\n⏰ 月末复盘：总结本月成果和不足\n⏰ 下月计划：基于复盘设定下月目标',
                    'default': '⏰ 优先处理重要紧急的事\n⏰ 集中处理碎片化任务\n⏰ 预留应急时间处理意外\n⏰ 定期检视时间使用效率'
                };
                return time[id] || time['default'];
            }
        },
        module3: {
            title: '📊 工作成果量化',
            content: (id, name) => {
                const data = {
                    'daily-report-template': '📊 完成量：完成了多少任务\n📊 质量指标：交付物的质量评分\n📊 效率提升：相比之前效率提升多少\n📊 协作产出：帮助团队完成了什么',
                    'sales-daily-report': '📊 新增客户：今日新增多少潜在客户\n📊 跟进记录：今日跟进多少客户\n📊 成交金额：今日成交多少钱\n📊 转化率：跟进转化为成交的比例',
                    'operations-daily-report': '📊 DAU/MAU：日活月活数据\n📊 内容产出：发布多少内容\n📊 用户反馈：收到多少反馈和投诉\n📊 问题解决：解决了多少用户问题',
                    'default': '📊 数量指标：完成了多少\n📊 质量指标：完成质量如何\n📊 效率指标：花费了多少时间\n📊 影响指标：带来了什么影响'
                };
    ...
    sales: {
        ...
        module1: {
            ...
            content: (id, name) => {
                const funnel = {
                    'crm-sales-followup': '📋 漏斗阶段：线索→意向→谈判→成交→服务\n📋 转化率追踪：每个阶段的转化率\n📋 时间节点：每个阶段的平均周期\n📋 异常预警：阶段停滞超预期提醒',
                    'sales-followup-template': '📋 客户分层：ABC分类，重点客户重点跟进\n📋 跟进频率：A类客户每周2次，B类每周1次\n📋 跟进记录：每次跟进详细记录要点\n📋 下次计划：每次跟进明确下次跟进时间',
                    'default': '📋 阶段管理：清楚知道客户在哪个阶段\n📋 转化目标：设定每个阶段的转化目标\n📋 时间把控：避免客户在某个阶段停滞太久\n📋 资源分配：把时间投入到高意向客户'
                };
                return funnel[id] || funnel['default'];
            }
        },
        module2: {
            title: '💡 成交率提升技巧',
            content: (id, name) => {
                const tips = {
                    'crm-sales-followup': '💡 需求挖掘：深入了解客户的真实需求\n💡 方案定制：根据客户需求提供定制方案\n💡 价值展示：让客户看到投入产出比\n💡 紧迫感：适度制造购买紧迫感',
                    'sales-followup-template': '💡 快速响应：客户咨询5分钟内响应\n💡 专业形象：展示行业专业知识\n💡 信任建立：通过案例和口碑建立信任\n💡 跟进节奏：保持适度频率，不冷淡不骚扰',
                    'default': '💡 了解需求：不盲目推销，先了解客户需求\n💡 展示价值：让客户看到产品/服务的价值\n💡 处理异议：客户有顾虑时及时解答\n💡 促进成交：适度催促，不要太佛系'
                };
                return tips[id] || tips['default'];
            }
        },
        module3: {
            ...
            content: (id, name) => {
                const crm = {
                    'crm-sales-followup': '🔧 录入完整：客户信息录入要完整准确\n🔧 标签管理：用标签分类客户，便于筛选\n🔧 自动化：设置自动化任务和提醒\n🔧 数据分析：用CRM数据分析客户行为',
                    'sales-followup-template': '🔧 记录习惯：每次跟进后立即记录要点\n🔧 客户画像：完善客户画像，了解客户\n🔧 跟进提醒：设置下次跟进提醒，避免遗忘\n🔧 协同分享：重要客户信息团队共享',
                    'default': '🔧 及时录入：跟进后立即录入CRM\n🔧 完整记录：记录客户需求、跟进进展\n🔧 设置提醒：重要节点设置提醒\n🔧 定期整理：定期清理和更新客户信息'
                };
                return crm[id] || crm['default'];
            }
        }
    }
};
...
const defaultModule = {
    module1: {
        title: '📋 使用指南',
        content: (id, name) => '✅ 根据实际情况填写对应内容\n✅ 保持信息完整和准确\n✅ 定期检查和更新内容\n✅ 如有问题参考常见问题部分'
    },
    module2: {
        title: '💡 实用技巧',
        content: (id, name) => '📌 保持简洁清晰，重点突出\n📌 定期备份重要数据\n📌 根据实际使用情况调整格式\n📌 遇到问题及时记录和解决'
    },
    module3: {
        title: '⚠️ 注意事项',
        content: (id, name) => '⚠️ 定期保存，避免数据丢失\n⚠️ 信息填写要准确完整\n⚠️ 重要数据建议多重备份\n⚠️ 遵守公司相关规定和要求'
    }
};

function getModules(category, templateId, templateName) {
    const catModules = CATEGORY_MODULES[category] || CATEGORY_MODULES['resume'];
    return {
        module1: catModules.module1 || defaultModule.module1,
        module2: catModules.module2 || defaultModule.module2,
        module3: catModules.module3 || defaultModule.module3
    };
}
...
templates.forEach(t => {
    ...
    const modules = getModules(t.category, t.id, t.name);
    ...
    const faqHtml = (t.faq || []).map(f=>'<div class="faq-item"><button class="faq-question" onclick="toggleFAQ(this)">'+f.question+'<span>▼</span></button><div class="faq-answer">'+f.answer+'</div></div>').join('') || '<p>暂无FAQ</p>';
    const scenariosHtml = (t.scenarios || ['适用于日常工作']).map(s=>'<li><strong>'+s+'</strong></li>').join('');
    const tipsHtml = (t.tips || ['使用前请仔细阅读说明']).map(t=>'<li><strong>'+t+'</strong></li>').join('');
    const mistakesHtml = (t.mistakes || ['避免常见错误']).map(m=>'<li>'+m+'</li>').join('');
    const exampleHtml = '<div class="example-box"><pre>' + (t.example || '请根据实际情况填写...\n基础信息：名称、日期、分类等\n具体内容：根据模板类型填写\n备注说明：补充信息') + '</pre></div>';
    ...
    // 分类专属模块
    const module1Content = modules.module1.content(t.id, t.name);
    const module2Content = modules.module2.content(t.id, t.name);
    const module3Content = modules.module3.content(t.id, t.name);
    
    const module1Html = '<div class="template-section"><h2>' + modules.module1.title + '</h2><div class="module-content"><pre>' + module1Content + '</pre></div></div>';
    const module2Html = '<div class="template-section"><h2>' + modules.module2.title + '</h2><div class="module-content"><pre>' + module2Content + '</pre></div></div>';
    const module3Html = '<div class="template-section"><h2>' + modules.module3.title + '</h2><div class="module-content"><pre>' + module3Content + '</pre></div></div>';
...
console.log('Generated:', updated, 'pages with category-specific modules');
ENDSCRIPT